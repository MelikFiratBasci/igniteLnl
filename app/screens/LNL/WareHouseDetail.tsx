...
import { removeWareHouse } from "../../store"
...
const WareHouseDetail: React.FC<WareHouseDetailProps> = ({ route }) => {
    ...
    <Screen preset="fixed" safeAreaEdges={["top", "bottom"]} contentContainerStyle={$screenContainer}>
      <View style={$sectionListContentContainer}>
        <View style={{ flexDirection: "row", gap: spacing.md }}>
          ...
          <Text style={$name} preset="header" text="WareHouse Detail" />
          ...
          onPress={() => {
            Alert.alert(
              ...
              [
                ...
                {
                  text: "Delete", onPress: () => {
                    dispatch(removeWareHouse(item.id))
                    navigation.goBack()
                  }
                }
              ],
